...
describe("scheduler jobs", () => {
  ...
  test("reconcileMissingContractGeneration retries the Move-In generator for a moved-in reservation whose Contract never generated", async () => {
    contractFind.mockReturnValue(makePopulateChain([
      { _id: "contract-1", reservationId: "res-1", status: "draft", createdBy: "admin-1", updatedBy: null },
    ]));
  ...
  test("reconcileMissingContractGeneration retries the deposit-settled generator when the reservation is paid but not yet moved in", async () => {
    contractFind.mockReturnValue(makePopulateChain([
      { _id: "contract-2", reservationId: "res-2", status: "ready_for_generation", createdBy: "admin-2", updatedBy: "admin-3" },
    ]));
    reservationFindById.mockReturnValue(makePopulateChain({
      status: "reserved",
      initialPaymentStatus: "paid",

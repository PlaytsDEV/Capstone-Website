...
const PROJECTIONS = Object.freeze({
  reservations: { _id: 1, userId: 1, roomId: 1, currentStayId: 1, selectedBed: 1, status: 1, paymentStatus: 1, paymentExpiresAt: 1, paymongoSessionId: 1, monthlyRent: 1, totalPrice: 1, reservationFeeAmount: 1, applianceFees: 1, leaseDuration: 1, moveInDate: 1, confirmedMoveInDate: 1, approvedForPaymentAt: 1, depositRefundStatus: 1, depositRefundProcessedAt: 1, reservationCreditConsumedAt: 1, reservationCreditAppliedBillId: 1, isArchived: 1, archivedAt: 1, createdAt: 1, updatedAt: 1 },
  contracts: { _id: 1, tenantId: 1, reservationId: 1, stayId: 1, roomId: 1, branch: 1, contractNumber: 1, status: 1, isCurrent: 1, roomType: 1, bedId: 1, leaseType: 1, leaseDurationMonths: 1, regularMonthlyRate: 1, discountPercentage: 1, discountAmount: 1, approvedMonthlyRate: 1, advanceRentAmount: 1, securityDepositAmount: 1, reservationFeeAmount: 1, reservationFeeCreditAmount: 1, pricingApprovedAt: 1, signedUploadedAt: 1, "signedDocuments.version": 1, "signedDocuments.superseded": 1, notarizedUploadedAt: 1, "notarizedDocuments.version": 1, "notarizedDocuments.superseded": 1, publishedAt: 1, archivedAt: 1, createdAt: 1, updatedAt: 1 },
  bills: { _id: 1, reservationId: 1, userId: 1, tenantId: 1, stayId: 1, roomId: 1, branch: 1, billType: 1, billingMonth: 1, billingCycleStart: 1, additionalCharges: 1, charges: 1, reservationCreditApplied: 1, totalAmount: 1, grossAmount: 1, paidAmount: 1, amountPaid: 1, remainingAmount: 1, status: 1, description: 1, isArchived: 1, createdAt: 1, updatedAt: 1 },
  payments: { _id: 1, tenantId: 1, billId: 1, reservationId: 1, purpose: 1, amount: 1, expectedAmount: 1, paidAmount: 1, currency: 1, source: 1, externalSessionId: 1, externalPaymentId: 1, paymentReference: 1, status: 1, branch: 1, metadata: 1, notes: 1, createdAt: 1, updatedAt: 1 },
  ...
  users: { _id: 1, branch: 1, role: 1, isArchived: 1, archivedAt: 1 },
  stays: { _id: 1, tenantId: 1, reservationId: 1, branch: 1, roomId: 1, bedId: 1, monthlyRent: 1, status: 1, createdAt: 1, updatedAt: 1 },
  ...
  auditLogs: { _id: 1, timestamp: 1, action: 1, userId: 1, userRole: 1, branch: 1, entityType: 1, entityId: 1, metadata: 1 },
...
export async function loadAuditDataset(safety) {
  ...
  for (const [key, collectionName] of Object.entries(COLLECTIONS)) {
    ...
    dataset[key] = await db.collection(collectionName).find({}, { projection: PROJECTIONS[key], readConcern: { level: "majority" } }).sort({ _id: 1 }).toArray();

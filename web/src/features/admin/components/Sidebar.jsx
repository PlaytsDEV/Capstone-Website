    ...
    <aside className="admin-sidebar">
      ...
      <nav className="admin-sidebar-nav">
        <ul className="admin-sidebar-menu">
          ...
          {/* Inquiries + Reservations (unified as "Reservations") */}
          <li className="admin-sidebar-menu-item">
            <NavLink
          ...
          <li className="admin-sidebar-menu-item">
            ...
            >
              <span className="admin-sidebar-menu-icon">
                ...
                >
                  <path
                    d="M14.1668 17.5V15.8333C14.1668 14.9493 13.8156 14.1014 13.1905 13.4763C12.5654 12.8512 11.7176 12.5 10.8335 12.5H4.16683C3.28277 12.5 2.43493 12.8512 1.8098 13.4763C1.18468 14.1014 0.833496 14.9493 0.833496 15.8333V17.5"
                    stroke="currentColor"
                    strokeWidth="1.66667"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  ...
                  />
                  <path
                    d="M19.1668 17.5V15.8333C19.1663 15.0948 18.9202 14.3773 18.4679 13.7936C18.0156 13.2099 17.383 12.793 16.6668 12.6083"
                    stroke="currentColor"
                    strokeWidth="1.66667"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M13.3335 2.60834C14.0505 2.79192 14.6841 3.20892 15.1369 3.79268C15.5896 4.37644 15.8356 5.09445 15.8356 5.83334C15.8356 6.57223 15.5896 7.29024 15.1369 7.874C14.6841 8.45776 14.0505 8.87476 13.3335 9.05834"
                    stroke="currentColor"
                    strokeWidth="1.66667"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <span className="admin-sidebar-menu-text">User Management</span>
            </NavLink>
          </li>

          {/* Rooms (unified: availability, configuration, occupancy) */}
          <li className="admin-sidebar-menu-item">
            <NavLink
            ...
            >
              ...
              <span className="admin-sidebar-menu-text">Rooms</span>
            </NavLink>
          </li>
          ...
          <li className="admin-sidebar-menu-item">
            ...
            >
              ...
              <span className="admin-sidebar-menu-text">Audit Logs</span>
            </NavLink>
          </li>
        </ul>
      </nav>

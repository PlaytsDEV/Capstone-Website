  ...
  return (
    <div className="rounded-xl border border-border bg-card p-4 space-y-3 shadow-xs text-xs">
      ...
      <div className="flex items-start justify-between gap-2 pb-2.5 border-b border-border">
        ...
        <span className="inline-flex items-center text-[11px] font-semibold text-foreground border border-border px-2 py-0.5 rounded-md">
          <span>
          ...
          occupants.map((occ) => (
            ...
            >
              ...
              <button
                ...
                className="text-[11px] text-primary font-semibold hover:underline cursor-pointer ml-2 shrink-0"
              >

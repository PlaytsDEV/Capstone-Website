              ...
              <div className="tenant-detail-modal-section">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  ...
                  <button
                    ...
                    style={{ background: '#FFF7ED', color: '#E0752E', border: '1px solid #FED7AA', borderRadius: '8px', padding: '10px 16px', cursor: 'pointer', fontWeight: 600, fontSize: '13px', display: 'flex', alignItems: 'center', gap: '8px' }}
                  >

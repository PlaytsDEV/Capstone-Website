...
export default function RoomFormModal({ room, onClose, onSave }) {
  ...
  return createPortal(
    <div className="admin-modal-overlay" onClick={onClose}>
      ...
      >
        {/* Header is a direct flex child — stays sticky at top */}
        ...
        {/*
         * display:contents makes <form> a transparent wrapper.
         * admin-modal-body and admin-modal-footer become direct flex
         * children of admin-modal-content, so sticky header/footer works.
         */}
        <form
          id="room-form"
          ...
          <div className="admin-modal-body">
              ...
              <div className="image-upload-area">
                ...
                {form.images?.length ? (
                    ...
                    {form.images.map((entry) => (
                      ...
                      >
                        ...
                        <div className="image-preview-card__footer">
                          <span className="image-preview-card__name">
                            {entry.name}
                          </span>
                          <button
                            type="button"
                  ...
                  <span className="image-upload-hint">
                    Upload real room photos. Applicant browsing will use these
              ...
              <div className={`room-form-group ${errors.capacity ? "has-error" : ""}`}>
                ...
                {form.type === "private" && (
                  <span className="capacity-hint">
                    Private rooms are for 1 tenant (2 beds/bunk included) —
            ...
            {!isEdit && (
              <div className="room-form-hint">
                <strong>Note:</strong> Beds will be auto-generated based on the
                room type and capacity. You can adjust bed configuration after
                creation.
              </div>
            )}
          </div>

          {/* Footer is a direct flex child of admin-modal-content via display:contents */}

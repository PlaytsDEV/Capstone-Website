...
export default function AdminContractsPage() {
  ...
  const [filters, setFilters] = useState({
    search: "", branch: ALL, status: ALL, roomType: ALL, leaseType: ALL,
  });
  ...
  }, [filters.status, filters.branch, isOwner]);
        ...
        <PageShell.Content>
          ...
          <div className="contract-table-card">
            <DataTable
              ...
              emptyState={{ icon: FileSignature, title: "No Contracts found", description: "Create a draft from an eligible resident reservation to begin." }}
            />
          </div>
        </PageShell.Content>
      </PageShell>

...
export default function Dashboard() {
    ...
    switch (iconType) {
      case "inquiries":
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
              d="M21 15A2 2 0 0 1 19 17H7L4 21V5A2 2 0 0 1 6 3H18A2 2 0 0 1 20 5V15Z"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
      ...
      case "reservations":
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            />
            <path
              d="M22 11H2V20C2 21.1046 2.89543 22 4 22H20C21.1046 22 22 21.1046 22 20V11Z"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      case "tenants":
        return (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
              d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 15.1716C18.0783 14.4214 17.0609 14 16 14H8C6.93913 14 5.92172 14.4214 5.17157 15.1716C4.42143 16.9217 4 17.9391 4 19V21"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
  ...
  // Helper function for activity icons (prepared for future activity feed)
        ...
        return (
          <div className="admin-dashboard-activity-icon inquiry">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path
                d="M14 11.2A1.5 1.5 0 0 1 12.5 12.7H4.2L2 15V3.5A1.5 1.5 0 0 1 3.5 2H12.5A1.5 1.5 0 0 1 14 3.5V11.2Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        return (
          <div className="admin-dashboard-activity-icon reservation">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              />
              <path
                d="M14 3H2V14C2 14.5304 2.21071 15.0391 2.58579 15.4142C2.96086 15.7893 3.46957 16 4 16H12C12.5304 16 13.0391 15.7893 13.4142 15.4142C13.7893 15.0391 14 14.5304 14 14V3Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      case "booking":
        return (
          <div className="admin-dashboard-activity-icon booking">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path
                d="M14 8V12C14 12.5304 13.7893 13.0391 13.4142 13.4142C13.0391 13.7893 12.5304 14 12 14H2C1.46957 14 0.960859 13.7893 0.585786 13.4142C0.210714 13.0391 0 12.5304 0 12V4C0 3.46957 0.210714 2.96086 0.585786 2.58579C0.960859 2.21071 1.46957 2 2 2H10"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      case "tenant":
        return (
          <div className="admin-dashboard-activity-icon tenant">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path
                d="M13 14V12.2C13 11.0799 12.5056 10.0157 11.6112 9.22183C10.7168 8.427 9.50936 8 8.25 8H3.75C2.49064 8 1.28317 8.427 0.388849 9.22183C-0.505474 10.0157 -1 11.0799 -1 12.2V14"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <div className="admin-dashboard-bottom-section">
          ...
          <div className="admin-dashboard-inquiries-section">
            <div className="admin-dashboard-inquiries-header">
              ...
              <a href="#view-all" className="admin-dashboard-view-all">
                View All
              </a>
            </div>

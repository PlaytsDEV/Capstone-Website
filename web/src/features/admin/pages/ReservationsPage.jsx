                ...
                {reservations.map((reservation) => (
                  ...
                  >
                    ...
                    <td className="admin-reservations-table-td">
                      ...
                      <div className="admin-reservations-date-label">
                        Charged Fri
                      </div>
                    </td>
                    <td className="admin-reservations-table-td">
                      <div className="admin-reservations-expiry-date">
                        {reservation.expiry}
                      </div>
                      <div
                        className={`admin-reservations-expiry-days ${reservation.status === "Expired/Cancelled" ? "expired" : ""}`}
                      >

...
function UserManagementPage() {
  ...
  const handleCreateUser = async (e) => {
    ...
    showNotification(
      "User creation from admin panel requires backend endpoint implementation. Please use Firebase Console or registration page for now.",
      "info",
      5000,
    );

    // TODO: Implement POST /api/users endpoint in backend
    // This endpoint should:
    // 1. Use Firebase Admin SDK to create user account
  ...
  return (
    <div className="admin-layout">
      <Sidebar />
      <main className="admin-main-content admin-users-page">

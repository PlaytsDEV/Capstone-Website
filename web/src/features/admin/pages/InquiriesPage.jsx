...
export default function InquiriesPage() {
      ...
      <main className="admin-inquiries-main">
        <header className="admin-inquiries-header">
          <div>
            ...
            <p className="admin-inquiries-subtitle">View and respond to customer inquiries</p>
          </div>
        </header>
        ...
        <section className="admin-inquiries-tools">
          ...
          <select className="admin-inquiries-filter">
        ...
        <section className="admin-inquiries-table">
          ...
          <div className="admin-inquiries-table-body">
            {rows.map((row) => (
              <div key={row.id} className="admin-inquiries-row">
                <div className="admin-inquiries-cell">
                  <span className="admin-inquiries-name">{row.name}</span>
                </div>
                <div className="admin-inquiries-cell">
  ...
  <g clip-path="url(#clip0_113_170)">
    <path d="M11 3.5L6.5045 6.3635C6.35195 6.45211 6.17867 6.49878 6.00225 6.49878C5.82583 6.49878 5.65255 6.45211 5.5 6.3635L1 3.5" stroke="#4A5565" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M10 2H2C1.44772 2 1 2.44772 1 3V9C1 9.55228 1.44772 10 2 10H10C10.5523 10 11 9.55228 11 9V3C11 2.44772 10.5523 2 10 2Z" stroke="#4A5565" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
  ...
  <path d="M13.3332 6.66668C13.3332 9.99534 9.6405 13.462 8.4005 14.5327C8.28499 14.6195 8.14437 14.6665 7.99984 14.6665C7.85531 14.6665 7.71469 14.6195 7.59917 14.5327C6.35917 13.462 2.6665 9.99534 2.6665 6.66668C2.6665 5.25219 3.22841 3.89563 4.2286 2.89544C5.2288 1.89525 6.58535 1.33334 7.99984 1.33334C9.41433 1.33334 10.7709 1.89525 11.7711 2.89544C12.7713 3.89563 13.3332 5.25219 13.3332 6.66668Z" stroke="#99A1AF" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M8 8.66666C9.10457 8.66666 10 7.77123 10 6.66666C10 5.56209 9.10457 4.66666 8 4.66666C6.89543 4.66666 6 5.56209 6 6.66666C6 7.77123 6.89543 8.66666 8 8.66666Z" stroke="#99A1AF" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
  ...
  <g clip-path="url(#clip0_113_292)">
    <path d="M6 3V6L8 7" stroke="#99A1AF" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M6 11C8.76142 11 11 8.76142 11 6C11 3.23858 8.76142 1 6 1C3.23858 1 1 3.23858 1 6C1 8.76142 3.23858 11 6 11Z" stroke="#99A1AF" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
  ...
  <defs>
    <clipPath id="clip0_113_255">
      <rect width="16" height="16" fill="white"/>
                  ...
                  <button className="admin-inquiries-action delete" aria-label="Delete">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">

 ...
 * - Redirects admins to admin dashboard, regular users to home page
...
function SignIn() {
   ...
   * 3. Redirect to admin dashboard for admins, home page for regular users
   ...
   * 5. Redirect to admin dashboard for admins, home page for regular users
   */
  ...
  /**
   * Handle post-authentication flow (redirects)

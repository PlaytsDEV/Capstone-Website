...
import standardRoomImage from "../../../assets/images/gpuyat/standard-room.jpg";
import deluxeRoomImage from "../../../assets/images/gpuyat/deluxe-room.jpg";
import premiumRoomImage from "../../../assets/images/gpuyat/premium-room.jpg";
...
function PrivateRoomPage() {
  ...
  const roomData = {
    ...
    beds: "1 bed",
    images: [standardRoomImage, deluxeRoomImage, premiumRoomImage],
    descriptions: [

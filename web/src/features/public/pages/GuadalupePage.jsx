...
function GuadalupePage() {
  ...
  return (
    <div className="guadalupe-page">
      ...
      {/* Hero Section */}
      <section className="guadalupe-hero" style={{ backgroundImage: `url(${gilPuyatBranchImage})` }}>
        ...
        <div className="guadalupe-container">
          <div className="guadalupe-hero-content">
            <div className="guadalupe-logo-section">
              ...
              <p className="guadalupe-logo-subtitle">Safe & Comfortable Living Space</p>
            </div>
        ...
        <div className="guadalupe-container">
          ...
          <div className="guadalupe-location-info">
            ...
            <div className="guadalupe-location-text">
              <p className="guadalupe-location-address">456 Guadalupe Avenue, Makati City, Metro Manila</p>
              <p className="guadalupe-location-desc">Easy access to NRIT and major business districts</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="guadalupe-rooms">
        <div className="guadalupe-container">
          ...
          <button className="guadalupe-btn-view-rooms">View All Rooms & Rates</button>
          ...
          <div className="guadalupe-rooms-grid">
            <div className="guadalupe-room-card">
              ...
              <button className="guadalupe-btn-view-details" onClick={() => navigate('/guadalupe/rooms/quadruple')}>View Details</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="guadalupe-gallery">
        <div className="guadalupe-container">
          <div className="guadalupe-carousel">
            <button className="guadalupe-carousel-btn guadalupe-carousel-prev" onClick={prevSlide}>
            ...
            <button className="guadalupe-carousel-btn guadalupe-carousel-next" onClick={nextSlide}>
              <svg xmlns="http://www.w3.org/2000/svg" width="8" height="14" viewBox="0 0 8 14" fill="none">

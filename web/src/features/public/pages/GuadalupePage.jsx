        ...
        <div className="guadalupe-container">
          <div className="guadalupe-hero-content">
            <div className="guadalupe-logo-section">
              <LilycrestLogo className="guadalupe-hero-logo" aria-label="Lilycrest Logo" />
            ...
            <div className="guadalupe-search-bar">
              <button onClick={() => navigate("/tenants/dashboard")} className="guadalupe-btn-search">Find Your Room</button>
            </div>
          </div>
        </div>
      </section>
  ...
  <path d="M10 10.8334C11.3807 10.8334 12.5 9.71409 12.5 8.33337C12.5 6.95266 11.3807 5.83337 10 5.83337C8.61929 5.83337 7.5 6.95266 7.5 8.33337C7.5 9.71409 8.61929 10.8334 10 10.8334Z" stroke="#FF6900" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <section className="guadalupe-rooms">
        <div className="guadalupe-container">
          ...
          <button onClick={() => navigate("/guadalupe/rooms")} className="guadalupe-btn-view-rooms">

    ...
    <div className="gpuyat-rooms-page">
        ...
        <div className="gpuyat-rooms-container">
          ...
          <div className="gpuyat-room-type-card">
            ...
            <div className="gpuyat-room-type-content">
              ...
              <p className="gpuyat-room-type-description">
                Perfect for those who value privacy and independence. These
                single-occupancy rooms come fully furnished with a comfortable
                bed, study desk, wardrobe, and air conditioning. Ideal for
                professionals or students who need their own space to focus and
                relax.
              </p>
              <div className="gpuyat-room-type-footer">
                ...
                <button
                  className="gpuyat-btn-view-room-details"
                  onClick={() => navigate("/gil-puyat/rooms/private")}
                >
                  View Details →
                </button>
              </div>
          ...
          <div className="gpuyat-room-type-card gpuyat-room-type-card-reverse">
            <div className="gpuyat-room-type-content">
              ...
              <p className="gpuyat-room-type-description">
                Share your space with a roommate in this comfortable
                double-occupancy room. Features two single beds, individual
                study desks, shared wardrobe space, and air conditioning. Great
                for making friends while keeping costs affordable.
              </p>
              <div className="gpuyat-room-type-footer">
                <div className="gpuyat-room-type-price">
                ...
                <button
                  className="gpuyat-btn-view-room-details"
                  onClick={() => navigate("/gil-puyat/rooms/double")}
                >
                  View Details →
                </button>
              </div>
          ...
          <div className="gpuyat-room-type-card">
            ...
            <div className="gpuyat-room-type-content">
              ...
              <p className="gpuyat-room-type-description">
                ...
                This quad room features bunk beds with individual reading
                lights, shared study area, lockers, and air conditioning. Build
                lasting friendships in a lively community atmosphere.
              </p>
              <div className="gpuyat-room-type-footer">
                <div className="gpuyat-room-type-price">
                ...
                <button
                  className="gpuyat-btn-view-room-details"
                  onClick={() => navigate("/gil-puyat/rooms/quadruple")}
                >
                  View Details →
                </button>
              </div>
      ...
      <section className="gpuyat-rooms-about">
        <div className="gpuyat-rooms-container">
          ...
          <p>
            Located in the vibrant Gil Puyat Avenue (formerly Buendia), our
            dormitory offers easy access to major business districts, shopping
            centers, and public transportation. Perfect for students and young
            professionals who want to be in the center of it all.
          </p>
          <p>
            Our Gil Puyat branch features modern, fully-furnished rooms designed
            for comfort and productivity. With 24/7 security, high-speed
            internet, and a community of like-minded individuals, this is more
            than just a place to stay—it's a lifestyle. Enjoy access to shared
            amenities including a fully-equipped kitchen, lounge areas, study

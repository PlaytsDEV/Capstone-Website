import { Wifi, Coffee, Utensils, Shirt, BookOpen, Users, Sofa, Dumbbell } from 'lucide-react';
...
const facilities = [
  ...
  },
  {
    icon: BookOpen,
    title: 'Study Lounge',
    description: 'Quiet, well-lit dedicated spaces perfect for focused studying and academic work',
    color: '#0C375F',
  ...
  },
  {
    icon: Sofa,
    title: 'Common Lounge',
    description: 'Comfortable shared space to relax, socialize, and build community with residents',
    color: '#0C375F',
...
export function FacilitiesSection() {
  return (
    <section className="py-24 lg:py-32" style={{ backgroundColor: '#0C375F' }} id="facilities">
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        {/* Header */}
        <div className="text-center mb-20">
          <p className="text-xs text-white/40 mb-3 tracking-widest uppercase font-light">Shared Spaces</p>
          ...
          <p className="text-white/60 max-w-2xl mx-auto font-light leading-relaxed">
            Beyond your room, enjoy access to well-maintained common areas designed for studying, cooking, and relaxation.
          </p>
        </div>

    ...
    <section className="py-24 lg:py-32 bg-white" id="pricing">
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        ...
        <div className="text-center mb-20">
          <p className="text-xs text-gray-400 mb-3 tracking-widest uppercase font-light">Transparent Pricing</p>
          ...
          <p className="text-gray-500 max-w-2xl mx-auto font-light leading-relaxed">
            No hidden fees, no surprises. Here's exactly what you're paying for each month.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {pricingPlans.map((plan, index) => (
            ...
            >
              {/* Popular Badge */}
              {plan.popular && (
                <div className="text-center py-3 text-white text-xs font-light tracking-wider uppercase" style={{ backgroundColor: '#E7710F' }}>
                  Most Popular
                </div>
              )}
              ...
              <div className="p-8">
                {/* Header */}
                <div className="mb-8">
                  <h3 className="text-2xl font-normal mb-2 tracking-tight" style={{ color: '#0C375F' }}>
                    {plan.type}
                  </h3>
                  <p className="text-xs text-gray-400 font-light mb-6">{plan.branch}</p>
                  <div className="flex items-baseline gap-2">
                    <span className="text-5xl font-light tracking-tight" style={{ color: '#E7710F' }}>
                      {plan.price}
                    </span>
                ...
                {/* Included */}
                <div className="mb-6">
                  <p className="text-xs text-gray-400 mb-4 font-light tracking-wider uppercase">What's Included</p>
                  <ul className="space-y-3">
                    {plan.included.map((item, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        <Check className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#EDB938' }} />
                ...
                {/* Excluded */}
                <div className="mb-8">
                  <p className="text-xs text-gray-400 mb-4 font-light tracking-wider uppercase">Not Included</p>
                  <ul className="space-y-3">
        ...
        <div className="mt-16 max-w-4xl mx-auto">
          <div className="p-8 rounded-3xl bg-gradient-to-br from-gray-50 to-white border border-gray-100">
            <h4 className="text-lg font-normal mb-4 tracking-tight" style={{ color: '#0C375F' }}>
              Payment Terms
            </h4>
            <ul className="space-y-2 text-sm text-gray-600 font-light">
              <li className="flex items-start gap-3">
                <span className="text-gray-400">•</span>
                <span>Security deposit: One month advance + one month deposit required upon move-in</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gray-400">•</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-gray-400">•</span>
                <span>Electricity charges above the allocation will be billed separately based on meter reading</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gray-400">•</span>

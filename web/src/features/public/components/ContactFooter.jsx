...
const socialLinks = [
  { icon: FacebookIcon, href: 'https://facebook.com/lilycrest', label: 'Facebook' },
  { icon: InstagramIcon, href: 'https://instagram.com/lilycrest', label: 'Instagram' },
  { icon: TiktokIcon, href: 'https://tiktok.com/@lilycrest', label: 'TikTok' },
];

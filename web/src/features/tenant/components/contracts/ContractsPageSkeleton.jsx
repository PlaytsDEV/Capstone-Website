...
/**
 * ContractsPageSkeleton — shimmer skeleton that mirrors the ContractsPage layout 1:1.
 */
export default function ContractsPageSkeleton() {
  return (
    <div aria-hidden="true" className="contracts-page">
      {/* Page Header */}
      <div className="contracts-header" style={{ marginBottom: 24 }}>
      ...
      <div
        style={{
          ...
          borderRadius: 12,
          border: "1px solid var(--border-divider, #E8EBF0)",
          padding: "24px",
          marginBottom: 20,
        }}
      >

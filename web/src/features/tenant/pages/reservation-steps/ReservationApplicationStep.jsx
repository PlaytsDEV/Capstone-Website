      ...
      <div className="rf-app-section__header">
        ...
        >
          <ChevronDown
            size={20}
            strokeWidth={2.2}
            className={`rf-app-section__chevron${isOpen ? " is-open" : ""}`}
          />
        </button>
      </div>

      <div
        id={`section-${sectionKey}-panel`}
        className={`rf-app-section__body${isOpen ? " is-open" : ""}`}
        aria-hidden={!isOpen}
      >
...
const ReservationApplicationStep = ({
  ...
  const [openSections, setOpenSections] = useState(() =>
    buildOpenSectionState((section, index) => index === 0),
  );
  ...
  const doResetAll = () => {
    ...
    setFieldErrors({});
    setOpenSections(buildOpenSectionState((section, index) => index === 0));
  };
  ...
  const devAutoFill = () => {
    ...
    setTargetMoveInDate(moveInMin);
    setEstimatedMoveInTime("08:00");
    setWorkSchedule("day");
    setWorkScheduleOther("");
    setLeaseDuration("12");
  ...
  return (
    <div className="reservation-card rf-application-card">
      <div className="rf-app-header">
        <div className="rf-app-header__icon" aria-hidden="true">
      ...
      <div className="rf-app-sections">
        ...
        <CollapsibleSection
          ...
          sectionRef={(el) => {
            sectionRefs.current.agreements = el;
          }}
          contentClassName={readonlyContentClass}
        >
          <AgreementsSection

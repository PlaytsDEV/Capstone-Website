    ...
    <div className="guadalupe-rooms-page">
          ...
          <div className="guadalupe-room-type-card">
            ...
            <div className="guadalupe-room-type-content">
              ...
              <p className="guadalupe-room-type-description">
                Our most economical option designed for students and interns. This quad room features comfortable beds with individual reading lights, shared study area, lockers, and air conditioning. Build lasting friendships in a vibrant community atmosphere.
              </p>
              <div className="guadalupe-room-type-footer">
                ...
                <button className="guadalupe-btn-view-room-details" onClick={() => navigate('/guadalupe/rooms/quadruple')}>View Details →</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="guadalupe-rooms-about">
        <div className="guadalupe-rooms-container">
          ...
          <p>Located in the peaceful yet accessible Guadalupe area, our dormitory offers a perfect balance of tranquility and convenience. Close to major business districts, shopping centers, and educational institutions, it's an ideal choice for students and young professionals.</p>
          <p>Our Guadalupe branch features spacious, fully-furnished rooms designed for comfort and community. With 24/7 security, high-speed internet, and modern amenities, this is your ideal home away from home. Enjoy access to shared facilities including a fully-equipped kitchen, lounge areas, study rooms, and laundry facilities.</p>
        </div>
      </section>

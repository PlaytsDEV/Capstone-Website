...
function GPuyatRoomsPage() {
  ...
  return (
    <div className="gpuyat-rooms-page">
      {/* Navigation */}
      <nav className="gpuyat-rooms-navbar">
        <div className="gpuyat-rooms-container">
          <div className="gpuyat-rooms-nav-content">
            <button onClick={() => {}} className="gpuyat-rooms-nav-link">Home</button>
            <button onClick={() => {}} className="gpuyat-rooms-nav-link">Location</button>
            <button onClick={() => {}} className="gpuyat-rooms-nav-link active">Room & Rates</button>
          </div>
        </div>
      </nav>

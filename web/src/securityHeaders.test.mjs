...
test("vercel.json contains all 6 required security headers on global route /(.*)", () => {
...
test("serve.json in public/ matches security headers for local preview parity", () => {
  ...
  assert.ok(headerKeys.has("x-frame-options"), "serve.json must have X-Frame-Options");
});

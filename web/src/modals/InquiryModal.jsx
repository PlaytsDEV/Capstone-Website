  ...
  return (
    <div className="inquiry-modal-overlay" onClick={onClose}>
      <div className="inquiry-modal-content" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="inquiry-modal-form-section">
            ...
            <form onSubmit={handleSubmit} className="inquiry-form">
              ...
              <div className="inquiry-form-group">
                <label htmlFor="name" className="inquiry-label">Name <span className="required">*</span></label>
                <input
                  type="text"
                  id="name"
                  name="name"
              ...
              {/* Email Field */}
              <div className="inquiry-form-group">
                <label htmlFor="email" className="inquiry-label">Email Address <span className="required">*</span></label>
                <input
                  type="email"
                  id="email"
                  name="email"
              ...
              {/* Phone Field */}
              <div className="inquiry-form-group">
                <label htmlFor="phone" className="inquiry-label">Phone Number</label>
                <input
                  type="tel"
                  id="phone"
                  name="phone"
              ...
              {/* Message Field */}
              <div className="inquiry-form-group">
                <label htmlFor="message" className="inquiry-label">Message <span className="required">*</span></label>
                <textarea
                  id="message"
                  name="message"
              ...
              {/* Submit Button */}
              <button type="submit" className="inquiry-btn-submit">Send Inquiry</button>
            </form>
          </div>
          ...
          <div className="inquiry-modal-contact-section">
            ...
            <div className="inquiry-contact-info-item">
              <div className="inquiry-contact-info-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <g clipPath="url(#clip0_5_577)">
                    <path d="M18.3334 5.8335L10.8409 10.606C10.5866 10.7537 10.2978 10.8315 10.0038 10.8315C9.70974 10.8315 9.42094 10.7537 9.16669 10.606L1.66669 5.8335" stroke="#FF6900" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M16.6667 3.3335H3.33335C2.41288 3.3335 1.66669 4.07969 1.66669 5.00016V15.0002C1.66669 15.9206 2.41288 16.6668 3.33335 16.6668H16.6667C17.5872 16.6668 18.3334 15.9206 18.3334 15.0002V5.00016C18.3334 4.07969 17.5872 3.3335 16.6667 3.3335Z" stroke="#FF6900" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                  </g>
                  <defs>
              ...
              <div className="inquiry-contact-info-text">
                ...
                <p className="inquiry-contact-info-value">reservations@lilycrest.ph</p>
              </div>
            </div>
            ...
            <div className="inquiry-contact-info-item">
              <div className="inquiry-contact-info-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <path d="M16.6666 8.33317C16.6666 12.494 12.0508 16.8273 10.5008 18.1657C10.3564 18.2742 10.1806 18.333 9.99998 18.333C9.81931 18.333 9.64354 18.2742 9.49915 18.1657C7.94915 16.8273 3.33331 12.494 3.33331 8.33317C3.33331 6.56506 4.03569 4.86937 5.28593 3.61913C6.53618 2.36888 8.23187 1.6665 9.99998 1.6665C11.7681 1.6665 13.4638 2.36888 14.714 3.61913C15.9643 4.86937 16.6666 6.56506 16.6666 8.33317Z" stroke="#FF6900" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M10 10.8335C11.3807 10.8335 12.5 9.71421 12.5 8.3335C12.5 6.95278 11.3807 5.8335 10 5.8335C8.61929 5.8335 7.5 6.95278 7.5 8.3335C7.5 9.71421 8.61929 10.8335 10 10.8335Z" stroke="#FF6900" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <div className="inquiry-contact-info-text">
                <p className="inquiry-contact-info-label">Address</p>
                <p className="inquiry-contact-info-value">Gil Puyat Branch:<br />123 Gil Puyat Ave, Makati</p>
                <p className="inquiry-contact-info-value">Makati Branch:<br />456 Buendia Ave, Makati</p>
              </div>
            </div>
            ...
            <div className="inquiry-contact-info-item">
              <div className="inquiry-contact-info-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <g clipPath="url(#clip0_5_603)">
                    <path d="M10 5V10L13.3333 11.6667" stroke="#FF6900" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M10 18.3332C14.6024 18.3332 18.3334 14.6022 18.3334 9.99984C18.3334 5.39746 14.6024 1.6665 10 1.6665C5.39765 1.6665 1.66669 5.39746 1.66669 9.99984C1.66669 14.6022 5.39765 18.3332 10 18.3332Z" stroke="#FF6900" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                  </g>
                  <defs>
              ...
              <div className="inquiry-contact-info-text">
                ...
                <p className="inquiry-contact-info-value">Monday - Friday<br />9:00 AM - 6:00 PM</p>
                <p className="inquiry-contact-info-value">Saturday<br />10:00 AM - 4:00 PM</p>
              </div>
            </div>
        ...
        <div className="inquiry-modal-contacts">
        </div>
      </div>
    </div>
  );

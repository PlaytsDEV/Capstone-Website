...
import { createDebouncedClick } from "../utils/socialAuthManager";
  ...
  return (
    <>
      ...
      <button
        ...
        disabled={loading}
        aria-busy={loading}
        aria-label={loading ? "Connecting to Google authentication" : "Continue with Google sign-in"}
      >
        {loading ? (
          <svg className="w-5 h-5 auth-spinner" viewBox="0 0 24 24" fill="none" aria-hidden="true">

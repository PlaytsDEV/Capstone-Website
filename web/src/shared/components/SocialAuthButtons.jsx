...
const SocialAuthButtons = ({
  ...
  <>
    ...
    <div className="grid grid-cols-2 gap-4">
      <button
        type="button"
        className="flex items-center justify-center gap-3 px-4 py-4 rounded-xl bg-white border border-gray-200 hover:bg-gray-50 transition-all"
      ...
      >
        {loading ? (
          <svg className="w-5 h-5 animate-spin" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M12 2a10 10 0 019.95 9" stroke="#E7710F" strokeWidth="3" strokeLinecap="round" />
          </svg>
        ) : (

...
| 8 | VISIT_STATUS | `VISIT_STATUS.html` | {{STATUS_LABEL}} \| Lilycrest Dormitory | TENANT_NAME, ROOM_NAME, BRANCH_NAME, VISIT_CODE, VISIT_SCHEDULE, PREVIOUS_SCHEDULE, REMARKS, STATUS_LABEL, STATUS_INTRO, NEXT_STEP, SCHEDULE_LABEL, CTA_LABEL, CTA_URL | `RESEND_TEMPLATE_VISIT_STATUS` |

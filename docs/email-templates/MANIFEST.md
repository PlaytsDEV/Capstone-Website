...
| 8 | VISIT_STATUS | `VISIT_STATUS.html` | {{STATUS_LABEL}} \| Lilycrest Dormitory | TENANT_NAME, ROOM_NAME, BRANCH_NAME, BRANCH_SUBTITLE, VISIT_CODE, VISIT_SCHEDULE, PREVIOUS_SCHEDULE, REMARKS, STATUS_LABEL, STATUS_INTRO, NEXT_STEP | `RESEND_TEMPLATE_VISIT_STATUS` |

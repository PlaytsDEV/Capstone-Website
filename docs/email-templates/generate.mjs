...
templates.push({
  ...
  variables: ["TENANT_NAME", "ROOM_NAME", "BRANCH_NAME", "VISIT_CODE", "VISIT_SCHEDULE", "PREVIOUS_SCHEDULE", "REMARKS", "STATUS_LABEL", "STATUS_INTRO", "NEXT_STEP", "SCHEDULE_LABEL", "CTA_LABEL", "CTA_URL"],
  html: shell({
    ...
    bodyHtml:
      ...
      detailsPanel(
        ...
        row("{{SCHEDULE_LABEL}}", "{{VISIT_SCHEDULE}}") +

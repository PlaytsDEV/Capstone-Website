      ...
      <main className="admin-audit-main">
        ...
        <div className="audit-header">
          ...
          <div className="audit-header-text">
            ...
            <p>Monitor all system activities and maintain audit trails</p>
          </div>
        </div>
                    ...
                    <tr key={log.logId || log._id}>
                      ...
                      <td>
                        <div className="log-activity">
                          ...
                          <span className="log-activity-text">
                            {log.action}
                          </span>
                        </div>
                      </td>
                      <td>
                        <div className="log-user">
                          ...
                          {log.ip && (
                            <div className="log-user-ip">{log.ip}</div>
                          )}
                        </div>
                      </td>
                      <td>
                  ...
                  {Array.from(
                    ...
                    <button
                      ...
                      style={{
                        ...
                        borderRadius: "6px",
                        backgroundColor:
                          page === pagination.currentPage ? "#2563eb" : "white",
                        color:
